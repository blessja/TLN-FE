              ...
              <div className="flex z-10 flex-col px-5 text-black max-md:max-w-full">
                ...
                <div className="mt-2 max-sm:text-sm text-xl leading-7 max-md:max-w-full relative mb-[32px]">
                  <div className="mb-8">
                    ...
                    into the beauty of the Spanish language and enjoy the
                    excitement of mastering Spanish at your own pace with our
                    1:1 or Group Online Classes.
                  </div>{" "}
...
export default SpanishPageMainBanner;
